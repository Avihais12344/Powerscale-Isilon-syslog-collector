...
def send_audit_event(
    ...
    try:
        ...
        audit_message = f"{event_id}|{user_sid}|{user_id}|{zone_name}|{zone_id}|{client_ip}|{protocol}|{operation}|{nt_status}|{desired_access}|{is_directory}|{create_result}|{inode}|{filename}"
